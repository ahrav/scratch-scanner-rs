...
| **FS Log Format**   | `src/store/log/format.rs`      | Framed FS persistence codec (legacy V1 + position-bound V2 with segment trailer integrity) for run metadata + finding batches |
